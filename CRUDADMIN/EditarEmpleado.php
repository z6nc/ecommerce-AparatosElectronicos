...
<html lang="en">
  ...
  <?php
        include('../CRUDADMIN/ModificarEmpleado.php');
        ?>  
    ...
    <div class="containerGeneral" data-aos="zoom-out" >
        ...
        <hr>
       <form  action="../CRUDADMIN/ModificarEmpleado.php" method="POST" enctype="multipart/form-data" >
       <input type="hidden" name="idEmple" value="<?php echo $idEmple; ?>">
        <div class="mb-3" >
            <label class="form-label"  >DNI: </label>
            <input type="text" class="form-control"   minlength="8"   maxlength="8"   name="dni"  value="<?php echo $dni; ?>" required >
            
        </div>   
      
        <div class="mb-3" >
            <label class="form-label"  >NOMBRE :</label>
            <input type="text" class="form-control"   minlength="8"   maxlength="20"   name="nombreEm"  value="<?php echo $nombreEm; ?>"     required >
            
        </div>   
    
        <div class="mb-3">
            <label class="form-label " >USUARIO: </label>
            <input type="text" class="form-control"  maxlength="20"  minlength="4"  name="usuarioEm" value="<?php echo $usuarioEm; ?>"   required>
            
        </div>
        <div class="mb-3">
            <label class="form-label ">CONTRASEÑA: </label>
            <input type="password" class="form-control"     minlength="4"  maxlength="20"  name="contraseñaEm" value="<?php echo $contraseñaEm; ?>" required >
