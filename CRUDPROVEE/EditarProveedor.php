...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
       ...
       <?php
        include('../CRUDPROVEE/ModificarProve.php');
        ?>  
    ...
    <div class="containerGeneral" data-aos="zoom-out" >
        ...
        <form  action="../CRUDPROVEE/ModificarProve.php" method="POST" enctype="multipart/form-data" >
        <input type="hidden" name="idProveedor" value="<?php echo $idProveedor; ?>">
        <div class="mb-3"  >
            <label class="form-label"   >RUC: </label>
            <input type="text" class="form-control"  minLength="4" maxlength="11"  name="rucPro"  value="<?php echo $rucPro; ?>"  required >
            
        </div>   
      
        <div class="mb-3"  >
            <label class="form-label"   >RAZON SOCIAL:</label>
            <input type="text" class="form-control"   minLength="3"  maxlength="30"   name="razonPro" value="<?php echo $razonPro; ?>" required  >
            
        </div>   
        <div class="mb-3" >
            <label class="form-label"  >TELEFONO: </label>
            <input type="text" class="form-control"  minlength="9" maxlength="9" min  name="telefonoPro"  value="<?php echo $telefonoPro; ?>" required>
            
        </div>
        <div class="mb-3" >
            <label class="form-label"  >USUARIO: </label>
            <input type="text" class="form-control"  minLength="4" maxlength="12"  name="usuarioPro"  value="<?php echo $usuarioPro; ?>"  required>
            
        </div>
        <div class="mb-3" >
            <label class="form-label" >CONTRASEÑA: </label>
            <input type="password" class="form-control"  minLength="4" maxlength="12"  name="contraseñaPro"  value="<?php echo $contraseñaPro; ?>"  required>
