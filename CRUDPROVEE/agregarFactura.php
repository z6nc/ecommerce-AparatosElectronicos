    ...
    <div class="containerGeneral" data-aos="zoom-out">
        ...
        <form action="../CRUDPROVEE/insertarFactura.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control"  name="productoP"  required>
                
            </div>
            <div class="mb-3">
                <label class="form-label">PRECIO UNITARIO: </label>
                <input type="text" class="form-control" name="precioF" id="precio" required>

            </div>
            <div class="mb-3">
                <label class="form-label">CANTIDAD : </label>
                <input type="text" class="form-control"  name="cantidadP" id="cantidad" required>

            </div>
            <div class="mb-3">
                <label class="form-label">MONTO TOTAL : </label>
                <input type="text" class="form-control"  name="montoP"  id="montoFinal"  value="" readonly>
            ...
            var montoTotalInput = document.getElementById('montoFinal');

           
            
            precioInput.addEventListener('input', calcularMontoTotal);
