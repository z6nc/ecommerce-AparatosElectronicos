...
<!------------------------------------------------------------------------------------------------------------------------------ -->
 ...
 <!---------------------------------------- Formulario de agregar Productos ---------------------------------------------->
    ...
    <form  action="../CRUDPROVEE/insertarPago.php" method="POST" enctype="multipart/form-data" >
    ...
    <select class="form-select mb-3 "   name="nombreC">
        ...
        <div class="mb-3"  >
            ...
            <select class="form-select mb-3" name="formaP">
        ...
        <div class="mb-3" >
            ...
            <input type="date" class="form-control"     name="fechaP" required>
